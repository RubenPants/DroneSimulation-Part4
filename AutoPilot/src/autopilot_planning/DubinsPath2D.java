...
public class DubinsPath2D {
	...
	public static void main(String[] args) {
		...
		Vector3f start = new Vector3f(0.0,10.0,10.0);
		Vector3f end = new Vector3f(0.0,20.0,10.0);
		new DubinsPath2D(start, end, 450.0);
		if (ENABLE_LOGGING) System.out.println("Time taken for calculation of Dubins path = " + (System.nanoTime() - tic) / 10E6 + " ms");
	}
